...
#define BAT_CALIB_REAL_VOLTAGE        40.1       // input voltage measured by multimeter  
...
#define CONTROL_MOTOR_TEST_MAX_SPEED 500         // sweep slowly from -MAX_SPEED to MAX_SPEED (0 - 1000)
